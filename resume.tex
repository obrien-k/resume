...
\resumeSubItem{\href{https://github.com/orphic-inc/stellar-api}{stellar-api}}{A strict, type-safe REST API (Express, Prisma/PostgreSQL, Zod) powering an invite-only community platform, with auto-generated OpenAPI documentation, link-health monitoring, and a community reputation score. (2026)}
\vspace{5px}
\resumeSubHeadingListEnd
