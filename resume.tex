...
\employerTitle
  ...
  \resumeSubHeadingListStart
    \jobLineItem
      {Product Support Engineer (Full-time, Austin, TX)}{}
      \resumeItemListStart
        \resumeItem{\href{LINK}{Launched Help Center}}{Composed written content for Apollo’s Help Center resulting in over 100 public articles. Developed custom Algolia integration for ZenDesk Guide to align search results with Apollo.}
